function Footer() {
  return (
    <footer className="bg-zinc-50 text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left mt-10">
      <div className="flex items-center justify-center border-b-2 border-neutral-200 p-3 dark:border-white/10 lg:justify-between">
      ...
      <div className="mx-6 py-6 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="">
            ...
            <p>¿Quisieras trabajar con nosotros? ¡Envíanos tu CV!</p>
          </div>
          ...
          <div>
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start">
              <span className="me-3 [&>svg]:h-5 [&>svg]:w-5">
                <svg viewBox="0 0 24 24" fill="currentColor">
                  <path
                    fillRule="evenodd" // fillRule es para rellenar el icono
                    d="M1.5 4.5a3 3 0 013-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 01-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 006.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 011.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 01-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5z"
                    clipRule="evenodd" // clipRule es para recortar el icono
                  />
                </svg>
              </span>
              + 57 310 5656 65656
